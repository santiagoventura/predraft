            ...
            <form method="POST" action="<?php echo e(route('login.submit')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="password" 
                           name="password" 
                           id="password"
                           class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-gray-500 text-sm mt-4">
            &copy; <?php echo e(date('Y')); ?> MLB Fantasy Draft Helper
        </p>
    </div>
</body>
</html>
