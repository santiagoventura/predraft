    ...
    <div class="container mx-auto px-4 py-8" x-data="playerDataManager()" x-init="init()">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('leagues.index')); ?>" class="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700">
                    ← Back to Leagues
                </a>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-blue-50 p-4 rounded-lg">
                    <div class="text-3xl font-bold text-blue-600"><?php echo e($stats['total_players']); ?></div>
                    <div class="text-sm text-gray-600">Total Players</div>
                </div>
                
                <div class="bg-green-50 p-4 rounded-lg">
                    <div class="text-3xl font-bold text-green-600"><?php echo e($stats['projections_2026']); ?></div>
                    <div class="text-sm text-gray-600">2026 Projections</div>
                </div>
                
                <div class="bg-red-50 p-4 rounded-lg">
                    <div class="text-3xl font-bold text-red-600"><?php echo e($stats['injuries_active']); ?></div>
                    <div class="text-sm text-gray-600">Active Injuries</div>
                </div>
                
                <div class="bg-purple-50 p-4 rounded-lg">
                    <div class="text-3xl font-bold text-purple-600"><?php echo e($stats['scores_2026']); ?></div>
            ...
            <div class="mt-4 p-3 bg-gray-50 rounded border border-gray-200">
                <div class="text-sm text-gray-600">
                    🕐 Last updated: <span class="font-semibold"><?php echo e($lastUpdated); ?></span>
                </div>
            </div>
            <?php else: ?>
        ...
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-8 mb-6 text-white">
            ...
            <form action="<?php echo e(route('admin.player-data.start-update')); ?>" method="POST" x-show="!updating">
                <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between"><span>Batters:</span><span class="font-semibold"><?php echo e($stats['batters']); ?></span></div>
                    <div class="flex justify-between"><span>Pitchers:</span><span class="font-semibold"><?php echo e($stats['pitchers']); ?></span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between"><span>Total Leagues:</span><span class="font-semibold"><?php echo e($stats['leagues']); ?></span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function playerDataManager() {
            return {
                ...
                checkProgress() {
                    fetch('<?php echo e(route("admin.player-data.progress")); ?>')
                        .then(r => r.json())
                        .then(data => {
...
<?php /**PATH /var/www/resources/views/admin/player-data/index.blade.php ENDPATH**/ ?>